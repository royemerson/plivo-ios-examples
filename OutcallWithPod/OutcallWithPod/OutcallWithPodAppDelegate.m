...
#import "OutcallWithPodAppDelegate.h"

@implementation OutcallWithPodAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = (OutcallWithPodViewController *)self.window.rootViewController;
